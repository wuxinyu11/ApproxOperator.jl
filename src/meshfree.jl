...
function cal∇²𝗠!(ap::ReproducingKernel,x::NTuple{3,Float64})
    ...
    for xᵢ in 𝓒
        Δx = x - xᵢ
        𝒑, ∂𝒑∂x, ∂𝒑∂y, ∂𝒑∂z, ∂²𝒑∂x², ∂²𝒑∂y², ∂²𝒑∂z², ∂²𝒑∂x∂y, ∂²𝒑∂x∂z, ∂²𝒑∂y∂z = get∇²𝒑(ap,Δx)
        𝜙, ∂𝜙∂x, ∂𝜙∂y, ∂𝜙∂z, ∂²𝜙∂x², ∂²𝜙∂y², ∂²𝜙∂z², ∂²𝜙∂x∂y, ∂²𝜙∂x∂z, ∂²𝜙∂y∂z = get∇²𝜙(ap,xᵢ,Δx)
        for I in 1:n
            for J in I:n
                𝗠[I,J] += 𝜙*𝒑[I]*𝒑[J]
                ∂𝗠∂x[I,J] += ∂𝜙∂x*𝒑[I]*𝒑[J] + 𝜙*∂𝒑∂x[I]*𝒑[J] + 𝜙*𝒑[I]*∂𝒑∂x[J]
...
function get∇²𝝭(ap::ReproducingKernel,𝒙::NTuple{3,Float64})
    ...
    return 𝝭, ∂𝝭∂x, ∂𝝭∂y, ∂𝝭∂z, ∂²𝝭∂x², ∂²𝝭∂y², ∂²𝝭∂z², ∂²𝝭∂x∂y, ∂²𝝭∂x∂z, ∂²𝝭∂y∂z
end
