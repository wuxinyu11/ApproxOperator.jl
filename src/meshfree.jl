...
function set∇̃²𝝭!(gp::ReproducingKernel{SNode,𝒑,𝑠,𝜙,:Tri3},ap::ReproducingKernel{SNode,𝒑,𝑠,𝜙,:Tri3}) where {𝒑,𝑠,𝜙}
    ...
    for ξ̂ in 𝓖
        ...
        for ξ in ap.𝓖
            ...
            𝒒̂ᵀ𝗚⁻¹∂²𝒒∂η² = 𝒒̂ᵀ𝗚⁻¹*∂²𝒒∂η²
            nᵇ₁ = 0.0;nᵇ₂ = 0.0;sᵇ₁ = 0.0;sᵇ₂ = 0.0
            ξ.ξ == 0.0 ? (nᵇ₁ += n₁₁;nᵇ₂ += n₁₂;sᵇ₁ += s₁₁;sᵇ₂ += s₁₂) : nothing
            ξ.η == 0.0 ? (nᵇ₁ += n₂₁;nᵇ₂ += n₂₂;sᵇ₁ += s₂₁;sᵇ₂ += s₂₂) : nothing
            ξ.ξ+ξ.η ≈ 1.0 ? (nᵇ₁ += n₃₁;nᵇ₂ += n₃₂;sᵇ₁ += s₃₁;sᵇ₂ += s₃₂) : nothing
            𝐿 = (nᵇ₁^2+nᵇ₂^2)^0.5
            ...
            W₂₂₁ = mn₂₂*nᵇ₁*wᵇ
            W₂₂₂ = mn₂₂*nᵇ₂*wᵇ
            ms₁₁ = (q₁*sᵇ₁+q₂*sᵇ₂)*nᵇ₁*sᵇ₁/𝐿^2
            ms₁₂ = (q₁*sᵇ₁+q₂*sᵇ₂)*0.5*(nᵇ₁*sᵇ₂+nᵇ₂*sᵇ₁)/𝐿^2
            ms₂₂ = (q₁*sᵇ₁+q₂*sᵇ₂)*nᵇ₂*sᵇ₂/𝐿^2
            # W₁₁ = (q₁₁*w + 2*(q₁*nᵇ₁+ms₁₁)*wᵇ)/4/𝐴
            # W₁₁ = ((q₁*sᵇ₁+q₂*sᵇ₂)*nᵇ₁*sᵇ₁+(q₁*nᵇ₁+q₂*nᵇ₂)*nᵇ₁*nᵇ₁)*wᵇ/𝐿^2
            W₁₁ = (q₁*nᵇ₁+q₂*nᵇ₂)*nᵇ₁*nᵇ₁*wᵇ/𝐿^2
            W₁₂ = (q₁₂*w + (q₁*nᵇ₂+q₂*nᵇ₁+ms₁₂)*wᵇ)/4/𝐴
            W₂₂ = (q₂₂*w + 2*(q₂*nᵇ₂+ms₂₂)*wᵇ)/4/𝐴
            for i in 1:length(𝓒)
